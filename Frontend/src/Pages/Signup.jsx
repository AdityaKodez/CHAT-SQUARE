    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen w-full">
        <div className="right flex justify-center flex-col items-center w-full gap-4">
          <Logo Title="Create Account" Content="Get started with your free account"/>
          
          <form onSubmit={HandleSubmit}>
            <div className="flex justify-center items-center w-full flex-col gap-4 p-5">
              <label className="input validator">
                <svg className="h-[1.1em] text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" fill="none" stroke="currentColor"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></g></svg>
                <input type="input" 
                  required 
