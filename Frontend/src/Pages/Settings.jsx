      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 space-y-6 lg:space-y-0">
        ...
        <div>
          <div className="flex flex-col gap-1">
            <h2 className="text-3xl mb-1 font-semibold">Theme</h2>
            <p className="text-sm text-base-content/70">Choose a theme for your chat interface</p>
          </div>

          <div className="grid grid-cols-3 sm:grid-cols-6 md:grid-cols-6 lg:grid-cols-4 gap-2 mt-4">
            {themes.map((t) => (
              <button
                key={t}
                className={`
                ...
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-sm">FAKER</h3>
