        ...
        <div className="right flex w-full justify-center items-center flex-col gap-7">
          ...
          <form className=" w-full flex justify-center items-center flex-col gap-5 lg:w-[80%] md:w-[80%]" onSubmit={handleSubmit}>
            <label className="input validator flex items-center gap-3 w-[60%]">
              <svg className="h-[1.1em] opacity-50 invert-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" fill="none" stroke="currentColor"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></g></svg>
              <input type="email" 
                name="email"
            ...
            <label className="input validator flex items-center gap-3 w-[60%]">
              <img src="./src/assets/key.svg" alt="h" className="h-[1em] opacity-50 invert-50" />
              <input 
                ...
                className="text-white font-poppins h-[1rem]" 
